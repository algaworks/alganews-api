...
( 5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$04$o1/wxlkdhHbUPjZXSBqftOGOEhhP0tehr7n/7.1xWazpIvcC21Bba', 'EDITOR', DATE_SUB(UTC_TIMESTAMP, INTERVAL 6 MONTH), DATE_SUB(UTC_TIMESTAMP, INTERVAL 6 MONTH), true, 'avatar-manoel.jpeg', 'Ut eu iaculis ipsum. Morbi et justo at ante blandit tristique. Etiam accumsan eleifend consectetur. Suspendisse quis feugiat massa, nec sodales justo.', '2001-03-05', '(71) 99748-0457', '90882025406', 13.15, 'Brasil', 'Salvador', 'Bahia', '001', '0151', '0515579', '7', 'SAVING' ),
